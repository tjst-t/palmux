...
| 用語 | 説明 |
|---|---|
| **ドロワー** | セッション・ウィンドウの一覧と操作メニュー。画面左からスライドイン |
| **セッションリスト** | ドロワー内のセッション一覧。各セッションは折りたたみ可能 |
| **ウィンドウリスト** | セッション展開時に表示されるウィンドウの一覧。仮想アイテム（Files / Git）と実ウィンドウで構成される |
| **Files アイテム** | ドロワーのウィンドウリスト内にある仮想アイテム。タップでファイルブラウザビューに切り替える。フォルダアイコン付き |
| **Git アイテム** | ドロワーのウィンドウリスト内にある仮想アイテム。タップで Git ブラウザビューに切り替える。Git グラフアイコン付き |
...
タブバーのタブタップ、またはドロワーの仮想アイテム（Files / Git）/ ウィンドウタップで切り替える。

| 用語 | 説明 |
|---|---|
| **ターミナルビュー** | xterm.js ターミナル + IME バー + ツールバーを表示するモード（デフォルト）。タブバーのウィンドウタブまたはドロワーのウィンドウタップで切り替え |
| **ファイルブラウザビュー** | ファイルブラウザを表示するモード。タブバーの Files タブまたはドロワーの Files アイテムタップで切り替え |
| **Git ブラウザビュー** | Git ブラウザを表示するモード。タブバーの Git タブまたはドロワーの Git アイテムタップで切り替え |
