...
func TestServer_RoutingWithBasePathRoot(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:       "POST /api/sessions: 認証あり → 200",
		...
		{
			name:       "DELETE /api/sessions/main: 認証あり → 200",
		...
		{
			name:       "POST /api/sessions/main/windows: 認証あり → 200",
			method:     http.MethodPost,
			path:       "/api/sessions/main/windows",
			withToken:  true,
			wantStatus: http.StatusOK,
		...
		{
			name:       "DELETE /api/sessions/main/windows/0: 認証あり → 200",
			method:     http.MethodDelete,
...
func TestServer_RoutingWithBasePathPalmux(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:       "POST /palmux/api/sessions: 認証あり → 200",
			method:     http.MethodPost,
			path:       "/palmux/api/sessions",
			withToken:  true,
			wantStatus: http.StatusOK,
		...
		{
			name:       "DELETE /palmux/api/sessions/main: 認証あり → 200",
			method:     http.MethodDelete,
		...
		{
			name:       "POST /palmux/api/sessions/main/windows: 認証あり → 200",
			method:     http.MethodPost,
			path:       "/palmux/api/sessions/main/windows",
			withToken:  true,
			wantStatus: http.StatusOK,
		...
		{
			name:       "DELETE /palmux/api/sessions/main/windows/0: 認証あり → 200",
			method:     http.MethodDelete,
...
func TestServer_RoutingWithDeepNestedBasePath(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:       "DELETE /deep/nested/path/api/sessions/main: 認証あり → 200",
			method:     http.MethodDelete,
